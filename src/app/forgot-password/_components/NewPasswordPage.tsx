...
import { NewPasswordType } from "@/types/requests";
...
const NewPasswordPage = () => {
  ...
  const passwordMutation = useMutation({
    ...
    mutationFn: (data: NewPasswordType) => resetPasswordWithLink(data, token!),
  });

  const handleSubmit = async (values: NewPasswordType) => {
